	...
	<div class="user-bio-block">
		...
		<ul class="bio-list list-unstyled">			
			...
			@if( $event->gender != null )
				<li>
					<i class="fa fa-genderless"></i> <b>Gender: </b> {!! ucfirst($event->gender) !!}
				</li>
			@endif

			@if( $event->price != null )
				<li>
					<i class="fa fa-money"></i> <b>Price: </b> {!! $event->price !!}
				</li>
			@endif

				<li>
					<i class="fa fa-fire"></i> <b>Focus: </b> {!! ucfirst($event->focus) !!}
				</li>
				<li>
					<i class="fa fa-calendar"></i> <b>Frequency: </b> {!! ucfirst($event->frequency) !!}
				</li>
