							...
							<ul class="list-group">
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										...
										<?php echo e(Form::select('email_follow', array('yes' => trans('common.yes'), 'no' => trans('common.no')), $userSettings->email_follow, array('class' => 'form-control'))); ?>
								...
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										...
										<?php echo e(Form::select('email_like_post', array('yes' => trans('common.yes'), 'no' => trans('common.no')), $userSettings->email_like_post, array('class' => 'form-control'))); ?>
								...
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										...
										<?php echo e(Form::select('email_post_share', array('yes' => trans('common.yes'), 'no' => trans('common.no')), $userSettings->email_post_share, array('class' => 'form-control'))); ?>
