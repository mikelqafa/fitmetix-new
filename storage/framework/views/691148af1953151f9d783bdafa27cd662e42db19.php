...
?>
            <a href="<?php echo e(url('user/gallery/'.$postImage->source)); ?>" data-lightbox="imageGallery.<?php echo e($post->id); ?>" ><img src="<?php echo e(url('user/gallery/thumbnail_'.$postImage->source)); ?>"  title="<?php echo e($post->user->name); ?>" class="post-image-content" alt="<?php echo e($post->user->name); ?>"></a>
          <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
