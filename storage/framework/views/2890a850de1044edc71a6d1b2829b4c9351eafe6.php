...
<?php endif; ?>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-4">
				...
				<form method="POST" class="login-form navbar-form navbar-right" action="<?php echo e(url('/login')); ?>">
					...
					<fieldset class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="<?php echo e(url('/register')); ?>" class="forgot-password"><i class="fa fa-user-plus"></i> Create new Account</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/password/reset')); ?>" class="forgot-password"><i class="fa fa-refresh"></i> Forgot your password</a>
                            </li>
                        </ul>
					</fieldset>
			...
			<?php else: ?>
			<ul class="nav navbar-nav navbar-right hidden-sm hidden-xs" id="navbar-right" v-cloak>
				<li><a href="<?php echo e(url(Auth::user()->username.'/create-event')); ?>"><i class="fa fa-cog"></i> <b>Inspire</b></a></li>
				<li><a href="<?php echo e(url('events')); ?>"><i class="fa fa-calendar"></i> <b>Event</b></a></li>
