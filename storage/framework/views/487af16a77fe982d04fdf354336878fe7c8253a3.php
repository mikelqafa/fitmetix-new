<form action="<?php echo e(url('')); ?>" method="post" class="create-post-form">
    ...
    <div class="panel panel-default panel-create"> <!-- panel-create -->
        ...
        <div class="panel-body" style="min-height: 132px">
            <div id="app-create-post">
                <app-create-post></app-create-post>
            </div>
            <input type="hidden" id="user-image" value="<?php echo e(asset('images/default.png')); ?>">
            <input type="hidden" id="post-placeholder" value="<?php echo e(trans('messages.post-placeholder')); ?>">
            ...
            <div class="user-tags-addon post-addon" style="display: none">
                ...
                <div class="form-group">
                    <input type="text" id="userTags" class="form-control user-tags youtube-text"
                           placeholder="<?php echo e(trans('messages.who_are_you_with')); ?>" autocomplete="off" value="">
            ...
            <div class="video-addon post-addon" style="display: none">
                ...
                <div class="form-group">
                    <input type="text" name="youtubeText" id="youtubeText" class="form-control youtube-text"
                           placeholder="<?php echo e(trans('messages.what_are_you_watching')); ?>" value="">
                    <div class="clearfix"></div>
                </div>
            </div>
            <?php if((env('SOUNDCLOUD_CLIENT_ID') != "" || (env('SOUNDCLOUD_CLIENT_ID') != null))): ?>
                <div class="music-addon post-addon" style="display: none">
                    ...
                    <div class="form-group">
                        <input type="text" name="soundCloudText" autocomplete="off" id="soundCloudText"
                               class="form-control youtube-text"
                               placeholder="<?php echo e(trans('messages.what_are_you_listening_to')); ?>" value="">
                        <div class="clearfix"></div>
                    </div>
                </div>
            ...
            <div class="location-addon post-addon" style="display: none">
                ...
                <div class="form-group">
                    <input type="text" name="location" id="pac-input" class="form-control"
                           placeholder="<?php echo e(trans('messages.where_are_you')); ?>" autocomplete="off" value=""
                           onKeyPress="return initMap(event)">
                    <div class="clearfix"></div>
                </div>
            </div>
            ...
            <input type="file" class="post-images-upload hidden" multiple="multiple"
                   accept="image/jpeg,image/png,image/gif" name="post_images_upload[]" id="post_images_upload">
        ...
        <div class="panel-footer">
            <ul class="list-inline left-list">
                ...
                <?php if((env('SOUNDCLOUD_CLIENT_ID') != "" || (env('SOUNDCLOUD_CLIENT_ID') != null))): ?>
                    <li><a href="javascript:;" id="musicUpload"><i class="fa fa-music"></i></a></li>
                <?php endif; ?>
                <li><a href="javascript:;" id="videoUpload"><i class="icon icon-youtube"></i></a></li>
            ...
            <ul class="list-inline right-list">
                <?php if($user_post == 'group' && Auth::user()->is_groupAdmin(Auth::user()->id, $timeline->groups->id) || $user_post == 'group' && $timeline->groups->event_privacy == 'members' && Auth::user()->is_groupMember(Auth::user()->id, $timeline->groups->id)): ?>
                    <li><a href="<?php echo url($username.'/groupevent/'.$timeline->groups->id); ?>"
                           class="btn btn-default"><?php echo e(trans('common.create_event')); ?></a></li>
                <?php endif; ?>

                <li>
                    <button type="submit" class="btn btn-submit ft-btn-primary"><?php echo e(trans('common.post')); ?></button>
                </li>
            </ul>
            <div class="clearfix"></div>
        </div>
