...
class Event extends Model
{
   ...
   * @var array
   */
    protected $fillable = ['timeline_id', 'type', 'user_id', 'start_date', 'end_date', 'active', 'invite_privacy', 'timeline_post_privacy','location','price','user_limit','group_id','focus','gender','frequency','currency'];
