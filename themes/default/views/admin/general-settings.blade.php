					...
					<div class="row">
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								{{ Form::text('site_name', Setting::get('site_name', 'Fitmetix'), array('class' => 'form-control', 'placeholder' => trans('admin.site_name') )) }}
							</fieldset>
						</div>
						<div class="col-md-6">
							<fieldset class="form-group">
								{{ Form::label('site_title', trans('admin.site_title')) }}
								{{ Form::text('site_title', Setting::get('site_title', 'Fitmetix'), array('class' => 'form-control', 'placeholder' => trans('admin.site_title'))) }}
							</fieldset>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-3">
							<img id="logo" class="socialite-logo" src="{{ url('setting/'.Setting::get('logo')) }}" alt="Fitmetix logo" title="Fitmetix logo"/>
						</div>
						<div class="col-md-3">
							<fieldset class="form-group">
						...
						<div class="col-md-3">
							<img id="favicon" class="socialite-favicon" src="{{ url('setting/'.Setting::get('favicon')) }}" alt="Fitmetix favicon" title="Fitmetix favicon" height="50" />
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								{{ Form::email('support_email', Setting::get('support_email', 'admin@Fitmetix.com'), array('class' => 'form-control'
						...
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								{{ Form::email('noreply_email', Setting::get('noreply_email', 'noreply@Fitmetix.com'), array('class' => 'form-control'
