    ...
    <div>
        ...
        <template v-if="!noPostFound || alreadyHavePost">
            ...
            <template v-else="">
                ...
                <div v-for="(postItem, index) in itemList" :key="index+'post'+postItem.id" class="panel panel-default ft-theme--color timeline-posts__item panel-post" :id="'ft-post'+postItem.id">
