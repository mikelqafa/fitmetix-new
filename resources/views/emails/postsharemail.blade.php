      ...
      <table cellspacing="0" cellpadding="0" width="600" class="w320">
        <tr>
          <td class="free-text">
            ...
            <h3 style="color: #757575;"><a style="text-decoration: none;color: #1E7C82;" href="{{ $user_url }}">{!! $user->name !!}</a> shared your <a style="text-decoration: none;color: #1E7C82;" href="{{ $post_url }}">post</a> </h3>
          </td>
        </tr>          
      </table>
    </center>
